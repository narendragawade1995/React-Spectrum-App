...
// const baseUrl = 'https://spectrumapi.edelweissarc.in/api/v3//api/v3/';
...
const getHeaders = async()=>{
    try {
        ...
        return {
            ...
            "Token" : token 
            // "Token" : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ODI4MCwidXNlcl9uYW1lIjoic2FkYW5hbmQubWFzdXJrYXIiLCJyb2xlX2lkIjoxMDE4LCJzZWN1cmV1c2VyIjpmYWxzZSwiaWF0IjoxNzIwNTg0OTQzLCJleHAiOjE3MjA2MjgxNDN9.bUobDxS9q_JSeKnYmTO7w1XdQMiUOn3pRZAS8Chtcek"
        } 
    } catch (error) {
